 ...
 * login, experience updates and retrieving the leaderboard.
 */
public final class ClientConnection {
    ...
    /**
     * 
     * @return - return true if the client connection was successful and 
     * false if it failed.
     */
     ...
     * @param screenName - client's screen name
     ...
     * 
     * @return returns what ever boolean value the server returns, true if 
     * the user was added to database and false if it failed.
     */
    public static boolean AddUser(String username, String password, String screenName, String name, String surname, String dateOfBirth, boolean gender, String email) {
        JSONObject obj = new JSONObject();
        try {
            ...
            obj.put("gender", Boolean.toString(gender));
            obj.put("email", email);
            outWriter.println(obj);
            return Boolean.parseBoolean(inReader.readLine().toString());
        }
    ...
    /**
     * RetrievePassword - sends the client's username in a JSON object to the server,
     * so that the client's password can be sent to hin via email.
     * 
     * @param username - client's username
     * 
     * @return - returns true or false, depending on if the email was sent to the
     * client, containing his/hers password.
     */
     ...
     * username and password, so that his/hers password can be changed in the database.
     * 
     * @param username - client's username.
     * @param password - client's password
     * 
     * @return returns true or false, depending on if the client's password
     * was changed successfully(then true) or not(then false).
     */
     ...
     * @param username - client's username.
     * 
     * @return - return the number of client's zombie kills or -1 if 
     * it failed.
     */
  ...
  /**
   * SetKills - send the number of client's zombie kills to the server
   * to be saved
   * 
   * @param username - client's username
   * @param zombieKills - client's number of zombie kills.
   * 
   * @return - returns true if the client's zombie kills was saved on
   * the server or false if it failed.
   */
    ...
    * @param username - client's username.
    * 
    * @return - returns true if the one kill was added server side and
    * false if it failed.
    */
