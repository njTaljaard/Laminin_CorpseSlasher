...
\epigraph{ XGame - Derivco \\ Functional requirements.}%
...
% % % % % % % % % % % % % % % 
	...
	\newpage
		...
		\begin{itemize}
			\item The game needs to be completed in a period of three months.
			\item The game needs to run on atleast two different platforms.
			\item The game must be developed using open source or freeware technologies available.
		\end{itemize}
