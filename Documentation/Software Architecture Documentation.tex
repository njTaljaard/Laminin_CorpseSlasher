...
% % % % % % % % % % % % % % % 
	...
	\newpage
		...
		\section*{\colorbox{black}{\makebox[\textwidth-2\fboxsep][l]{\bfseries\color{red} Vision }}} \addcontentsline{toc}{section}{Vision}
		\vspace{0.2in}
		...
		\section*{\colorbox{black}{\makebox[\textwidth-2\fboxsep][l]{\bfseries\color{red} Scope}}} \addcontentsline{toc}{section}{Scope}
		...
		\section*{\colorbox{black}{\makebox[\textwidth-2\fboxsep][l]{\bfseries\color{red} Sub-level use case diagrams}}} \addcontentsline{toc}{section}{Sub-level use case diagrams}
		...
		\section*{\colorbox{black}{\makebox[\textwidth-2\fboxsep][l]{\bfseries\color{red} Limitations \& Exclusions}}} \addcontentsline{toc}{section}{Limitations \& Exclusions}
		\vspace{0.2in}
		...
		\section*{\colorbox{black}{\makebox[\textwidth-2\fboxsep][l]{\bfseries\color{red} Architectural requirements }}} \addcontentsline{toc}{section}{Architectural requirements}
		\vspace{0.1in}
		...
		\vspace{0.2in}
		\section*{\colorbox{black}{\makebox[\textwidth-2\fboxsep][l]{\bfseries\color{red} Architectural patterns or styles }}}
		...
		\end{itemize}
		\vspace{0.2in}
		\section*{\colorbox{black}{\makebox[\textwidth-2\fboxsep][l]{\bfseries\color{red} Architectural tactics or strategies }}}
		...
		\vspace{0.2in}
		\section*{\colorbox{black}{\makebox[\textwidth-2\fboxsep][l]{\bfseries\color{red} Use of reference architectures and frameworks }}}
		...
		\vspace{0.2in}
		\section*{\colorbox{black}{\makebox[\textwidth-2\fboxsep][l]{\bfseries\color{red} Access and integration channels }}}
		...
		\vspace{0.2in}
		\section*{\colorbox{black}{\makebox[\textwidth-2\fboxsep][l]{\bfseries\color{red} Technologies }}}
		...
		\vspace{0.2in}
		\section*{\colorbox{black}{\makebox[\textwidth-2\fboxsep][l]{\bfseries\color{red} Technology Limitations }}}
		...
		\vspace{0.2in}
		\section*{\colorbox{black}{\makebox[\textwidth-2\fboxsep][l]{\bfseries\color{red} Overcoming limitations }}}
		...
		\vspace{0.2in}
		\section*{\colorbox{black}{\makebox[\textwidth-2\fboxsep][l]{\bfseries\color{red} Community contribution }}}
		...
		\section*{\colorbox{black}{\makebox[\textwidth-2\fboxsep][l]{\bfseries\color{red} Code Documentation }}} \addcontentsline{toc}{section}{Code Documentation}
						\vspace{0.1in}
		        ...
		        height - new height for the screen to have \\
				         ...
				         com.jme3.niftygui.NiftyJmeDisplay screen)
				             ...
				             com.jme3.niftygui.NiftyJmeDisplay Screen)
								...
								\addcontentsline{toc}{subsubsection}{Leaderboard}
								\vspace{0.1in}	
									\begin{itemize}
										\item	Field Summary
												\begin{itemize}
		...
		Parameters: \\
		    nifty - the nifty object that has to be designed Helper function to build, adding buttons and labels \\
								...
								\addcontentsline{toc}{subsubsection}{Leaderboard Controller}
								\vspace{0.1in}	
									\begin{itemize}
										\item	Field Summary
												\begin{itemize}
