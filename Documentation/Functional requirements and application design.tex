...
% % % % % % % % % % % % % % % 
	...
	\newpage
		...
		\begin{tabbing}
			...
			11/092014	\> Version 3.0	\> Updated the user-interface diagrams and pre	\> \\
						\>				\> and post conditions							\> Gerhard Smit\\
			...
			15/10/2014	\> Version 5.1 	\> Final read through							\> Nico Taljaard \\
			17/10/2014	\> Version 5.1	\> Added description to server sequence diagram.\> Martin Schoeman\\
		\end{tabbing}
		...
		\vspace{0.1in}
			...
			\vspace{0.1in}
				...
				\vspace{0.1in}
					...
					\item 4.1 The user can logout and is sent to the login screen again. All actions from 4.1.1 up till 7, excluding 4.2 \& 4.3, are the same as mentioned above. 
				...
				\vspace{0.1in}
					...
					This is the the sequence diagram for the communication between the client and server. Where between the ClientConnection(Client side) object and the ClientConnection(Server side) object, all the client and server communication happens and the rest of the sequence diagram are all the internal server calls between the three layers(Input, DatabaseUpdate and Database).
			...
			\vspace{0.1in}
				...
				\vspace{0.1in}
					...
					\begin{figure}[H]
					\centering
					\includegraphics[width=150mm]{UML_Diagram/Class/Server_Classes.jpg}
